...
COPY target/discoveryservice-0.0.1-SNAPSHOT.jar /var/jenkins_home/workspace/discoveryservice-0.0.1-SNAPSHOT.jar
ENTRYPOINT ["java","-jar","/var/jenkins_home/workspace/discoveryservice-0.0.1-SNAPSHOT.jar"]
EXPOSE 8761
